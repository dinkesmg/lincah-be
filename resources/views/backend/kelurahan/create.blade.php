        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">{{ isset($kelurahan) ? 'Edit' : 'Tambah' }} Kelurahan</h5>
                </div>
                <div class="card-body">
                    <form action="@isset($kelurahan) {{ route('kelurahan.update', $kelurahan->uuid) }} @endisset @empty($kelurahan) {{ route('kelurahan.store') }} @endempty"
                        ...
                        <label class="col-sm-2 col-form-label" for="kecamatan_id">Kecamatan</label>
                            <div class="col-sm-10">
                                {{html()->select('kecamatan_id', $kecamatan->pluck('nama', 'id'), isset($kelurahan) ? $kelurahan->kecamatan_id : @old('kecamatan_id'))->class('form-control select2')->placeholder('Masukkan Kecamatan')->required(true)}}
                                @error('kecamatan_id')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                {{html()->text('nama', isset($kelurahan) ? $kelurahan->nama : @old('nama'))->class('form-control')->placeholder('Masukkan Nama')->required(true)}}
                                @error('nama')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" id="koordinat" name="koordinat"
                                    value="{{ isset($kelurahan) ? $kelurahan->koordinat : old('koordinat') }}"
                        ...
                        <div class="row justify-content-end text-end">
                            <div class="col-sm-10">
                                <a href="{{ route('kelurahan.index') }}" class="btn btn-warning">Kembali</a>
